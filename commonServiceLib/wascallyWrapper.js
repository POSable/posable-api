...
WascallyRabbit.prototype.addTransactionEntry = function(payload) {
...
WascallyRabbit.prototype.addPaymentEntry = function(payload) {
...
WascallyRabbit.prototype.getEnvConnectionValues = function(env) {
    this.settings.connection = env;
};

WascallyRabbit.prototype.setHandle = function (messageType, func) {
